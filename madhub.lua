...
Domain.About_2.Text = "brought to you by DaMinion"
...
Admins = {3936902276,3800207826,2816411933,37962366,1984655763,262635913,1015797562,719084364,839408951,1373837031,2298490899,25798996,415918665,439204081}
Showcasers = {1239576294,1598108139,2325926644,254782537,261882701,839408951,2403423571,941788712}
Banned = {1004426362,4275450279,20655358,10516000,660242324,225493776}
Developers = {1239576294}
loldiscord = {"dude this is so cool","Domain","showcase this","watch this space","bruh","use magnius - rexi","domain winning","make it trending on twitter","oops","if this isnt in your auto exec, i will find you","preparing for lift off","dababy car","underrated","sirmeme make a video on domain hub","you know how i be, i just poopin","this table is long dude","discord.gg/","boost the server damn it","pog champ","imagine trying to crack domain hub"}
...
BackgroundExploits = {
	...
	lmber = {
		...
		PremiumOnly = false,
		WaitDuration = 0,
		Loadstring = "https://raw.githubusercontent.com/Butterisgood/butter-hub/main/Butterhub.txt",
	},
	fnf = {
		Name = "Funky Friday",
...
function BootDomain()
	...
	for _, Player in ipairs(game.Players:GetChildren()) do
		...
		booteddomain = "true"
		wait(4)
		Notify("Test","GothamBold",Color3.fromRGB(235, 0, 0))
		LoadPlayers()
	else
